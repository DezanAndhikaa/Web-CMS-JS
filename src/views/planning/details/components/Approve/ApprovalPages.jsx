...
class ApprovalPages extends React.Component {
  ...
  componentDidUpdate = (prevProps) => {
    ...
    if (
      this.props.approveSalesDownloaded.status ===
        ApiRequestActionsStatus.SUCCEEDED &&
      prevProps.approveSalesDownloaded.status ===
        ApiRequestActionsStatus.LOADING
    ) {
      this.onClickDownloadSalesApproved();
    }
    if (
      this.props.approveServiceDownloaded.status ===
        ApiRequestActionsStatus.SUCCEEDED &&
      prevProps.approveServiceDownloaded.status ===
        ApiRequestActionsStatus.LOADING
    ) {
    ...
    if (prevProps.filterParameter !== this.props.filterParameter) {
      if (this.props.indexFilterParameter.indexTabParameter === 0) {
        this.props.updateSalesParameter({
          ...prevProps.salesParameter.dataFilter,
          Filter: this.props.filterParameter.Filter,
          PageNumber: 1,
        });
      } else {
        this.props.updateServiceParameter({
          ...prevProps.serviceParameter.dataFilter,
          Filter: this.props.filterParameter.Filter,
          PageNumber: 1,
        });
      }
    ...
    if (prevProps.filterLifetime !== this.props.filterLifetime) {
      this.props.updateSalesParameter({
        ...prevProps.serviceParameter.dataFilter,
        Filter: this.props.filterLifetime.Filter,
        PageNumber: 1,
      });
    }
    ...
    if (prevProps.salesSearch !== this.props.salesSearch) {
      this.props.updateSearchParameter({
        Category: "Approval",
        Keyword: this.props.salesSearch,
      });
    }
    ...
    if (prevProps.serviceSearch !== this.props.serviceSearch) {
      ...
      this.props.updateSearchParameter({
        ...prevProps.dataFilter,
        Category: "Approval",
        Keyword: this.props.serviceSearch,
      });
    }
    ...
    if (prevProps.sortSalesBy !== this.props.sortSalesBy) {
      ...
      if (sortSalesBy.Customer.isActive) {
        ...
        if (
          sortSalesBy.Customer.isAscending === !sortSalesBy.Customer.isActive
        ) {
          isDescending = !sortSalesBy.Customer.isAscending;
          this.props.updateSalesParameter({
            ...this.props.salesParameter.dataFilter,
      ...
      if (sortSalesBy.UnitModel.isActive) {
        ...
        if (
          sortSalesBy.UnitModel.isAscending === !sortSalesBy.UnitModel.isActive
        ) {
          isDescending = !sortSalesBy.UnitModel.isAscending;
          this.props.updateSalesParameter({
            ...this.props.salesParameter.dataFilter,
      ...
      if (sortSalesBy.CompDesc.isActive) {
        ...
        if (
          sortSalesBy.CompDesc.isAscending === !sortSalesBy.CompDesc.isActive
        ) {
          isDescending = !sortSalesBy.CompDesc.isAscending;
          this.props.updateSalesParameter({
            ...this.props.salesParameter.dataFilter,
    ...
    if (prevProps.sortServiceBy !== this.props.sortServiceBy) {
      ...
      if (sortServiceBy.Customer.isActive) {
        ...
        if (
          sortServiceBy.Customer.isAscending ===
          !sortServiceBy.Customer.isActive
        ) {
          isDescending = !sortServiceBy.Customer.isAscending;
          this.props.updateServiceParameter({
            ...this.props.serviceParameter.dataFilter,
      ...
      if (sortServiceBy.UnitModel.isActive) {
        ...
        if (
          sortServiceBy.UnitModel.isAscending ===
          !sortServiceBy.UnitModel.isActive
        ) {
          isDescending = !sortServiceBy.UnitModel.isAscending;
          this.props.updateServiceParameter({
            ...this.props.serviceParameter.dataFilter,
      ...
      if (sortServiceBy.CompDesc.isActive) {
        ...
        if (
          sortServiceBy.CompDesc.isAscending ===
          !sortServiceBy.CompDesc.isActive
        ) {
          isDescending = !sortServiceBy.CompDesc.isAscending;
          this.props.updateServiceParameter({
            ...this.props.serviceParameter.dataFilter,
      ...
      return (
        <div className="paginations">
          <div className="paging-approval">
            ...
            {web && currentPropsSales - 3 > 0 && (
              <div
                onClick={() =>
                  this.props.updateSalesParameter({
                    ...this.props.salesParameter.dataFilter,
                    PageNumber: currentPropsSales - 3,
                  })
                }
                className="page-inactive-approval"
              >
                {currentPropsSales - 3}
              </div>
            )}
            {web && currentPropsSales - 2 > 0 && (
              <div
                onClick={() =>
                  this.props.updateSalesParameter({
                    ...this.props.salesParameter.dataFilter,
                    PageNumber: currentPropsSales - 2,
                  })
                }
                className="page-inactive-approval"
              >
            ...
            {currentPropsSales - 1 > 0 && (
              <div
                onClick={() =>
                  this.props.updateSalesParameter({
                    ...this.props.salesParameter.dataFilter,
                    PageNumber: currentPropsSales - 1,
                  })
                }
                className="page-inactive-approval"
              >
            ...
            {currentPropsSales + 1 <= TotalPages && (
              <div
                onClick={() =>
                  this.props.updateSalesParameter({
                    ...this.props.salesParameter.dataFilter,
            ...
            {web && currentPropsSales + 2 < TotalPages && (
              <div
                onClick={() =>
                  this.props.updateSalesParameter({
                    ...this.props.salesParameter.dataFilter,
            ...
            {web && currentPropsSales + 3 < TotalPages && (
              <div
                onClick={() =>
                  this.props.updateSalesParameter({
                    ...this.props.salesParameter.dataFilter,
      ...
      return (
        <div className="paginations">
          <div className="paging-approval">
            ...
            {web && currentPropsService - 3 > 0 && (
              <div
                onClick={() =>
                  this.props.updateServiceParameter({
                    ...this.props.serviceParameter.dataFilter,
                    PageNumber: currentPropsService - 3,
                  })
                }
                className="page-inactive-approval"
              >
                {currentPropsService - 3}
              </div>
            )}
            {web && currentPropsService - 2 > 0 && (
              <div
                onClick={() =>
                  this.props.updateServiceParameter({
                    ...this.props.serviceParameter.dataFilter,
                    PageNumber: currentPropsService - 2,
                  })
                }
                className="page-inactive-approval"
              >
                {currentPropsService - 2}
              </div>
            )}
            {currentPropsService - 1 > 0 && (
              <div
                onClick={() =>
                  this.props.updateServiceParameter({
                    ...this.props.serviceParameter.dataFilter,
                    PageNumber: currentPropsService - 1,
                  })
                }
                className="page-inactive-approval"
              >
                {currentPropsService - 1}
              </div>
            )}
            ...
            {currentPropsService + 1 <= TotalPages && (
              <div
                onClick={() =>
                  this.props.updateServiceParameter({
                    ...this.props.serviceParameter.dataFilter,
            ...
            {web && currentPropsService + 2 < TotalPages && (
              <div
                onClick={() =>
                  this.props.updateServiceParameter({
                    ...this.props.serviceParameter.dataFilter,
            ...
            {web && currentPropsService + 3 < TotalPages && (
              <div
                onClick={() =>
                  this.props.updateServiceParameter({
                    ...this.props.serviceParameter.dataFilter,
  ...
  _renderNotif() {
    return (
      <>
        <FilterbyDataAction {...this.props} titles="Input Lifetime" />
        <NotifButton {...this.props} idNotif="Non-Status" />
      </>
    );
  }
  ...
  onClickApprovedService = () => {
    this.props.fetchApprovedService(
      this.props.serviceParameter.dataFilter,
      this.props.token
    );
  };
  ...
  onClickDeletedService = () => {
    this.props.fetchDeletedService(
      this.props.serviceParameter.dataFilter,
      this.props.token
    );
  };
  ...
  handleSalesApprovedDownload = async () => {
    ...
    if (
      this.props.approveSalesDownloaded.status ===
      ApiRequestActionsStatus.FAILED
    ) {
  ...
  handleSalesApprove = async () => {
    ...
    if (this.props.selectedSalesPlans.length > 0) {
      ...
      await this.props.approveSales(
        { SoNumbers: arr, IsApprove: true },
        this.props.token
      );
      this.onClickSalesOrder();
  ...
  handleServiceApprove = async () => {
    ...
    if (this.props.selectedServicePlans.length > 0) {
      ...
      await this.props.approveService(
        { WoNumbers: arr, IsApprove: true },
        this.props.token
      );
      this.onClickServiceOrder();
  ...
  _renderFilterByDataAction = (value) => {
    if (this.state.whichTabs === true) {
      return (
        <>
          <FilterbyDataAction {...this.props} titles="Status" />
          <FilterbyDataAction {...this.props} titles="Tracking History" />
        </>
      );
    }
    if (this.state.whichTabs === false) {
  ...
  isChangeStat = (value, key) => {
    this.setState({
      lifetime: {
        Lists: this.state.lifetime.Lists.map((el) =>
          el.SoNumber === key ? { ...el, LifeTimeComp: value } : el
        ),
      },
    });
  };
    ...
    return (
      <>
        <UnapproveConfirmation
          idConfirm="Send Success"
          openModal={this.state.openSuccessEdit}
  ...
  updateAssignmentSalesStates = (plan) => {
    if (
      this.props.selectedSalesPlans.some(
        (plans) => plans.SoNumber === plan.SoNumber
      )
    ) {
  ...
  updateAssignmentServiceStates = (plan) => {
    if (
      this.props.selectedServicePlans.some(
    ...
    return (
      <>
        <ApprovalTab
          ...
          displaySalesCheckbox={
            this.props.salesParameter.paramsData.assigmentFilter ||
            this.props.salesParameter.paramsData.inProgressFilter
          }
          displayServiceCheckbox={
            this.props.serviceParameter.paramsData.assigmentFilter ||
            this.props.serviceParameter.paramsData.inProgressFilter
          }
  ...
  render() {
    return (
      <main className="content">
        {this.props.fetchStatusApprovedSales ===
          ApiRequestActionsStatus.LOADING && this.renderCircularProgress()}
        {this.props.fetchStatusApprovedSales ===
          ApiRequestActionsStatus.SUCCEEDED && (
          <>{this._renderSalesApproved()}</>
        )}
        {this.props.fetchStatusApprovedService ===
          ApiRequestActionsStatus.LOADING && this.renderCircularProgress()}
        {this.props.fetchStatusApprovedService ===
          ApiRequestActionsStatus.SUCCEEDED && (
          <>{this._renderSalesApproved()}</>
        )}
        {this.props.fetchStatusSalesDeleted ===
          ApiRequestActionsStatus.LOADING && this.renderCircularProgress()}
        {this.props.fetchStatusSalesDeleted ===
          ApiRequestActionsStatus.SUCCEEDED && (
          <>{this._renderSalesDeleted()}</>
        )}
        {this.props.fetchStatusServiceDeleted ===
          ApiRequestActionsStatus.LOADING && this.renderCircularProgress()}
        {this.props.fetchStatusServiceDeleted ===
          ApiRequestActionsStatus.SUCCEEDED && (
          <>{this._renderSalesDeleted()}</>
        ...
        {this.props.fetchStatusUnapprove ===
          ApiRequestActionsStatus.SUCCEEDED && this._renderEditSuccess()}
        <div className="table-container-approval">{this._renderTabs()}</div>
        <div></div>
        <div className="bottom-row-approval">
