...
export default class RevisedSalesOrderList extends React.PureComponent {
    ...
    return (
        <TableRow key={id} classes={{ root: 'table-row' }}>
          ...
          <TableCell align="left" className="table-cell">
            {this.props.salesOrderRevised.Data.Lists[id].LifeTimeComponent !== "-" ?
                <EditButton
                    {...this.props}
                    idEdit= "Rev"
                    ...
                    values= {this.props.salesOrderRevised.Data.Lists[id].LifeTimeComponent}
                    field= "edit"
                    id= {row.SoNumber} /> : ""}
          </TableCell>
  ...
  render() {
    if (this.props.salesOrderRevised.Data.Lists
        .length === 0 && this.props.fetchStatusRevised === ApiRequestActionsStatus.SUCCEEDED) {
      return (
          ...
          <div>
            <Table classes={{ root: 'table' }} className="table-rev">
              ...
              <TableBody classes={{ root: 'table-body' }}>
                {this.props.salesOrderRevised.Data.Lists
                && this.props.salesOrderRevised.Data.Lists
                    .map((row, id) => (
