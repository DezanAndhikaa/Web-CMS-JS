...
export default class SapServiceOrderList extends React.PureComponent {
            ...
            <TableCell className= "table-cell-checkbox">
              ...
              <Checkbox
                  ...
                  onClick={({target: { checked }}) => {
                    if(checked) return this.props.onChooseAllService(this.props.serviceOrderListSap.Data.Lists);
  ...
  render(){
    if (this.props.serviceOrderListSap.Data.Lists.length === 0 && this.props.fetchStatusServiceSap === ApiRequestActionsStatus.SUCCEEDED) {
      return (
          ...
          <>
            <Table classes={{ root: 'table' }} className="table">
              ...
              <TableBody classes={{ root: 'table-body' }}>
                {this.props.serviceOrderListSap.Data.Lists
                && this.props.serviceOrderListSap.Data.Lists.map((row, id) => (
