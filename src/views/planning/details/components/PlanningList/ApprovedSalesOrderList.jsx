...
export default class ApprovedSalesOrderList extends React.PureComponent {
              ...
              {this.props.displaySalesCheckbox && (
                  <Checkbox
                      ...
                      onClick={({target: { checked }}) => {
                        if(checked) return this.props.onChooseAllSales(this.props.salesOrderListApproved.Data.Lists);
  ...
  render(){
    if(this.props.salesOrderListApproved.Data.Lists.length === 0 && this.props.fetchStatusSalesApproved === ApiRequestActionsStatus.SUCCEEDED){
      return(
          ...
          <>
            <Table classes={{ root: 'table' }} className="table">
              ...
              <TableBody classes={{ root: 'table-body' }}>
                {this.props.salesOrderListApproved.Data.Lists
                && this.props.salesOrderListApproved.Data.Lists.map((row, id) => (
