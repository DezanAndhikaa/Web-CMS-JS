...
export default class DeletedServiceOrderList extends React.PureComponent {
            ...
            <TableCell className= "table-cell-checkbox">
              ...
              <Checkbox
                  ...
                  onClick={({target: { checked }}) => {
                    if(checked) return this.props.onChooseAllService(this.props.serviceOrderListDeleted.Data.Lists);
  ...
  render(){
    if(this.props.serviceOrderListDeleted.Data.Lists.length === 0 && this.props.fetchStatusServiceDeleted === ApiRequestActionsStatus.SUCCEEDED){
      return(
          ...
          <>
            <Table classes={{ root: 'table' }} className="table">
              ...
              <TableBody classes={{ root: 'table-body' }}>
                {this.props.serviceOrderListDeleted.Data.Lists
                && this.props.serviceOrderListDeleted.Data.Lists.map((row, id) => (
