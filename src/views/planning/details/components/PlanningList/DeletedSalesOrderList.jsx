...
export default class DeletedSalesOrderList extends React.PureComponent {
            ...
            <TableCell className= "table-cell-checkbox">
              ...
              <Checkbox
                  ...
                  onClick={({target: { checked }}) => {
                    if(checked) return this.props.onChooseAllSales(this.props.salesOrderListDeleted.Data.Lists);
  ...
  render(){
    if(this.props.salesOrderListDeleted.Data.Lists.length === 0 && this.props.fetchStatusSalesDeleted === ApiRequestActionsStatus.SUCCEEDED){
      return(
          ...
          <>
            <Table classes={{ root: 'table' }} className="table">
              ...
              <TableBody classes={{ root: 'table-body' }}>
                {this.props.salesOrderListDeleted.Data.Lists
                && this.props.salesOrderListDeleted.Data.Lists.map((row, id) => (
